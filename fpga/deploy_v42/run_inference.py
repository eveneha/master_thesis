...
inputs1 = np.load("pynq_input.npy")
...
def quantize_input(x_float, scale=0.007948528975248337, zero_point=0):
...
print(f"Input sample (all 665 values): {inputs1[0]}")  # This will print the first 1000 values
print(f"Input shape {inputs1.shape}")
